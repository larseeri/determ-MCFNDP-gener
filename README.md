(Dec 21st 2025)
### GENERATOR OF INSTANCES OF THE LINEAR, DETERMINISTIC,<br>MULTI-COMMODITY, FIXED CHARGE, CAPACITATED<br>NETWORK DESIGN PROBLEM<br>
...
b- In a Linux terminal, go to the /program subfolder just created.
...
main.cpp; at this point, the latter should exist
...
this order:
(i) initialization values hard-coded in lines 28-41 of data.cpp,
