...
Follow these steps to build the program:<br>
...
modifying line 792 of file main.cpp.) The default file name can be 
overridden with option +F:
...
taken from default configuration file whose name is specified in line 776 of
main.cpp; at this point, the latter should exist,<br>
...
Once the Docker engine is installed, follow these steps:<br>
...
from the terminal on AMD and Intel CPUs by adding this prefix (other CPUs
are adressed further below):
...
has initially been filled with illustrative values and should be edited 
...
this replaces the default file whose name is hard-coded in line 738 of
