...
'determ_gen' will be created inside the /program folder.<br>
...
has initially been filled with illustrative values and it should imperatively
be edited appropriately if no replacement configuration file is indicated on
the Docker instruction line with option key +F.
